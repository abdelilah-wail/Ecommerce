...
//     //                     class="color-option border px-4 py-2 rounded ${index === 0 ? 'bg-black text-white' : 'bg-white border-black'} transition-colors">
//     //                 ${color}
//     //             </button>
//     //         `;
//     //     });
...
//         colorOptionsHTML += `
//             <button data-color="${color}"
//                     class="color-option w-10 h-10 rounded-full ${colorClass} border-2 ${index === 0 ? 'border-black ring-2 ring-offset-2 ring-black' : 'border-gray-300'} transition-all">
